...
// Begin Class ASpartaPlayerController Function GetHUDWdiget
struct Z_Construct_UFunction_ASpartaPlayerController_GetHUDWdiget_Statics
{
	struct SpartaPlayerController_eventGetHUDWdiget_Parms
	{
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ASpartaPlayerController_GetHUDWdiget_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SpartaPlayerController_eventGetHUDWdiget_Parms, ReturnValue), Z_Construct_UClass_UUserWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ReturnValue_MetaData), NewProp_ReturnValue_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ASpartaPlayerController_GetHUDWdiget_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ASpartaPlayerController_GetHUDWdiget_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ASpartaPlayerController_GetHUDWdiget_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ASpartaPlayerController_GetHUDWdiget_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ASpartaPlayerController, nullptr, "GetHUDWdiget", nullptr, nullptr, Z_Construct_UFunction_ASpartaPlayerController_GetHUDWdiget_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ASpartaPlayerController_GetHUDWdiget_Statics::PropPointers), sizeof(Z_Construct_UFunction_ASpartaPlayerController_GetHUDWdiget_Statics::SpartaPlayerController_eventGetHUDWdiget_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ASpartaPlayerController_GetHUDWdiget_Statics::Function_MetaDataParams), Z_Construct_UFunction_ASpartaPlayerController_GetHUDWdiget_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_ASpartaPlayerController_GetHUDWdiget_Statics::SpartaPlayerController_eventGetHUDWdiget_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_ASpartaPlayerController_GetHUDWdiget()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ASpartaPlayerController_GetHUDWdiget_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(ASpartaPlayerController::execGetHUDWdiget)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	*(UUserWidget**)Z_Param__Result=P_THIS->GetHUDWdiget();
	P_NATIVE_END;
}
// End Class ASpartaPlayerController Function GetHUDWdiget
...
void ASpartaPlayerController::StaticRegisterNativesASpartaPlayerController()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		{ "GetHUDWdiget", &ASpartaPlayerController::execGetHUDWdiget },
...
struct Z_Construct_UClass_ASpartaPlayerController_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_ASpartaPlayerController_GetHUDWdiget, "GetHUDWdiget" }, // 2817409875
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_soneunsu_Documents_Unreal_Projects_SpartaProject_Source_SpartaProject_Public_SpartaPlayerController_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ASpartaPlayerController, ASpartaPlayerController::StaticClass, TEXT("ASpartaPlayerController"), &Z_Registration_Info_UClass_ASpartaPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASpartaPlayerController), 2824849202U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_soneunsu_Documents_Unreal_Projects_SpartaProject_Source_SpartaProject_Public_SpartaPlayerController_h_2546925557(TEXT("/Script/SpartaProject"),
	Z_CompiledInDeferFile_FID_Users_soneunsu_Documents_Unreal_Projects_SpartaProject_Source_SpartaProject_Public_SpartaPlayerController_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_soneunsu_Documents_Unreal_Projects_SpartaProject_Source_SpartaProject_Public_SpartaPlayerController_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
